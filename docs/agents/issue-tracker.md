...
- **Triage Roles & Labels**:
  - `ready-for-agent`: Workable vertical slices on the active frontier.
  - `icebox`: Parked Deferrals carrying an observable revisit condition.
  - `needs-triage`: Un-evaluated issues.
